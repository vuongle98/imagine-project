...
@Repository
public interface JpaUserConversationRepository extends
        JpaRepository<UserConversation, UUID>,
        BaseQueryRepository<UserConversation>,
        BaseRepository<UserConversation>,
